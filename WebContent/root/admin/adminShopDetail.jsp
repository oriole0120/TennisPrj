                    ...
                    <table class="board-tabled text-center">
                        ...
                        <tbody>
                            <tr class="board-rowd">
                                ...
                                <th class="board-celld board-cell-width-140d">${sh.name}</th>
                                <th class="board-celld board-cell-width-270d">${sh.address}</th>
                                <th class="board-celld board-cell-width-100d">${sh.phoneNumber}</th>
                                <th class="board-cell-th board-cell-width-100d">${sh.site}</th>
                            </tr>
                        </tbody>

                    </table>
                    <p>    
                     	<a id="btn-del-pop" href="adminShopDelProc.jsp?c=${sh.code}">삭제</a>
                    </p>
                </div>
